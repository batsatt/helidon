...
/**
 * A character buffer that acts as a {@link Writer} and uses {@link char[] arrays} cached via {@link SoftReference}.
 * <p>
 * <em>Note:</em> instances of this class are not thread-safe.
 */
public class CharBuffer extends Writer {
     ...
     */
    ByteBuffer encode(final Charset charset) {
    ...
    private static class Pool {
        ...
        /**
         * Gets an array from the pool if available or creates a new one.
         *
         * @return The array.
         */
        char[] acquire() {
