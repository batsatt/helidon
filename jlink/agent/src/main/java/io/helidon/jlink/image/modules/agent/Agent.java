...
package io.helidon.jlink.image.modules.agent;
...
public class Agent {
    ...
    public static void premain(String agentArgs, Instrumentation inst) throws Exception {
        ...
        Class<?> helidonPluginClass = loadClass(helidonModule, "io.helidon.jlink.image.modules.plugins.HelidonPlugin");
        Class<?> bootModulesPluginClass = loadClass(helidonModule, "io.helidon.jlink.image.modules.plugins.BootModulesPlugin");
        Class<?> bootOrderPluginClass = loadClass(helidonModule, "io.helidon.jlink.image.modules.plugins.BootOrderPlugin");
