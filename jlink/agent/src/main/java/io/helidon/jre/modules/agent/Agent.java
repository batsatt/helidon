...
package io.helidon.jre.modules.agent;
...
public class Agent {
    ...
    public static void premain(String agentArgs, Instrumentation inst) throws Exception {
        ...
        Module helidonModule = findModule("helidon.jre");
        ...
        Class<?> helidonPluginClass = loadClass(helidonModule, "io.helidon.jre.modules.plugins.HelidonPlugin");
        Class<?> bootModulesPluginClass = loadClass(helidonModule, "io.helidon.jre.modules.plugins.BootModulesPlugin");
        Class<?> bootOrderPluginClass = loadClass(helidonModule, "io.helidon.jre.modules.plugins.BootOrderPlugin");
